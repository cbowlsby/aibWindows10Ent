...
# image template name
$imageTemplateName="w36510entTemplate-01"
...
$sigGalleryName= "w365SharedImageGallery01"
$imageDefName ="win10w365"

# create gallery
New-AzGallery -GalleryName $sigGalleryName -ResourceGroupName $imageResourceGroup  -Location $location

# create gallery definition
New-AzGalleryImageDefinition -GalleryName $sigGalleryName -ResourceGroupName $imageResourceGroup -Location $location -Name $imageDefName -OsState generalized -OsType Windows -Publisher 'ChristopherB' -Offer 'Windows' -Sku '10w365'
...
$templateFilePath = "armTemplatew365v2.json"
